...
//        Q2. 상수 Pi를 만들고, 3.14로 초기화
        val Pi = 3.14
//        Pi = 31.4 => val로 만든 상수값은 수정 불가.
        Log.d("코틀린기초", String.format("%f", Pi))

//        Q3. 정수형 변수 num2 를 만들고, 초기화 X. 다음줄에서 20으로 대입.
        var num2:Int
...
//        코틀린에서는 모든 변수가 참조형 변수이므로, Int같은 기본형으로 추정되는 변수도 메쏘드/속성을 보유하고 있다.
        num2 = num2.plus(10)
        Log.d("코틀린기초", String.format("%d", num2))
